...
dat.gr.DB
dat.gr_df <- as.data.frame(dat.gr.DB)
write.table(dat.gr_df, "GR_DB_sites.txt",sep = "\t",row.names=FALSE)
...
dat.rp.DB
dat.rp_df <- as.data.frame(dat.rp.DB)
write.table(dat.rp_df, "RP_DB_sites.txt",sep = "\t",row.names=FALSE)
