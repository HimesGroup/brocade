...
peakHeatmap(dat.gr, TxDb=TxDb.Hsapiens.UCSC.hg38.knownGene,upstream=tss_span, downstream=tss_span)
plotAvgProf2(dat.gr, TxDb=TxDb.Hsapiens.UCSC.hg38.knownGene, upstream=tss_span, downstream=tss_span)
```

### Peaks genomic annotation distribution
...
plotDistToTSS(dat.anno)+scale_fill_brewer(palette = "RdPu")+ggtitle("")
```
